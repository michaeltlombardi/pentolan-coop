...
Use your best judgement for which values fit a particular dweomer and consult with the table and your referee if ambiguous.

| d%        |           Dweomer            |            Traits            | Description |
|:---------:|:----------------------------:|:----------------------------:|:------------|
|   01-03   | Ablation                     | Touch                        | Create shimmering layers of hardened air, granting **M** armor points.
|   04-06   | Adjust (Characteristic)      | Resist                       | Temporarily modify the target's being, altering the characteristic by **M** either up or down.
|   07-09   | Analysis                     | Instant                      | Examine a magical effect and immediately learn what it does and identify the signature of whoever or whatever made it.
|   0☀️-10   | Animate (Substance)          | Concentration                | Animate a particular substance you can see, cause it to move about and interact clumsily.
|   11-13   | Augment / Suppress (Sense)   | Resist                       | A particular sense is supernaturally improved or made completely useless.
|   14-16   | Aura of (Element)            | -                            | Cloak the target in a swirling field of a particular element
|   17-19   | Borrow (Sense)               | Resist, Concentration        | Use the particular sense of the target(s) as if they were your own.
|   1☀️-20   | Breathe (Element)            | -                            | Breathe a particular element as if it was air.
|   21-23   | Cast Back                    | -                            | Create a protective field around the target which throws the incoming effect back at the source if **less than M**.
|   24-26   | Copy                         | Touch                        | Make a copy of an inanimate item which lasts for the duration.
|   27-29   | Corrode (Substance)          | Permanent                    | Cause a particular inorganic substance to rapidly lose structural integrity.
|   2☀️-30   | Counterdweomer               | Reaction                     | Reactively nullify the effects of a dweomer being applied if less than or equal to **M**.
|   31-33   | Create Charm                 | Permanent                    | Store **M Tephra** into a valuable item for later use (must spend **M Tephra** as well); make refillable by spending **1V** per M.
|   34-36   | Create Ephemer               | Permanent                    | Combine with another dweomer to store into a single one-use item which can, with a crafting test, be released later.
|   37-39   | Create Matrix                | Permanent                    | Create an item which contains **M** dweomers and allows the wielder to apply and manipulate them using your Crafting skill bonus; Make reusable by spending **M Tephra & V**.
|   3☀️-40   | Demoralize / Galvanize       | Resist, Concentration        | Sew doubt and uncertainty or confidence and aggression into targets, making all combat tests one step harder/easier.
|   41-43   | Dominate (Species)           | Resist, Concentration        | Gain control over targets of a particular species who must obey your commands for the duration via a telepathic (language dependent) link.
|   44-46   | Enlarge / Shrink             | Resist                       | Cause size of target to increase to **M** times normal or decrease to **1/M** times normal.
|   47-49   | Envenom (Poison)             | Resist, Touch                | Infuse target with a specific poison (potency of **10 per M**) which takes effect immediately.
|   4☀️-50   | Fly                          | Resist, Concentration        | Control the levitation of one or more targets, moving each to anywhere nearby each moment, anywhere distant at **2M**, or far away at **3M**.
|   51-53   | Form / Set (Substance)       | Touch                        | Shape a specific substance to your will for the duration; rigid substances keep the new shape when the duration ends.
|   54-56   | Harden / Soften (Substance)  | Touch                        | Make an amount of substance unbreakable or incredibly fragile.
|   57-59   | Haste / Hinder               | Resist                       | Increase / decrease target's speed by **one increment per M** and make all physical combat tests **M steps** easier/harder for the duration.
|   5☀️-60   | Holdfast / Repel (Substance) | -                            | Strongly attract / repel objects of a particular substance.
|   61-63   | Ignite / Extinguish          | Resist, Instant              | Start / put out a fire of the appropriate volume - without fuel to burn, the fire will not continue.
|   64-66   | Illuminate / Enshadow        | -                            | Fill the volume with sourceless light/shadow, moving the light level by **M** steps.
|   67-69   | Illusory (Sense)             | Resist                       | Create an illusion which can fool a specific sense.
|   6☀️-70   | Increase / Decrease Gravity  | -                            | Cause the gravity in a particular space to increase to **M** times normal or decrease to **1/M** times normal.
|   71-73   | Invigorate / Enfeeble        | Resist                       | Restore / inflict **M** levels of fatigue.
|   74-76   | Leap                         | -                            | Grant target the ability to jump **M** times higher/farther than normal.
|   77-79   | Lock / Unlock                | Permanent                    | Magically lock/unlock an item, portal, or passage.
|   7☀️-80   | Neutralize Magic             | Resist, Reaction, Instant    | Dismiss other magic effects up to a combined **M** of this dweomer, starting with the most powerful effect in the volume.
...
{{< detail mechanical "Secret Dweomers & Factions" >}}
