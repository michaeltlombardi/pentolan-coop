...
{{< detail example "Actions and Tests: Locked Door" >}}
...
If you have a relevant skill, vocation, reputation, or other bonus, choose the highest one.
...
{{< detail example "Opposed Tests: Vying for Crowd Favor" >}}
